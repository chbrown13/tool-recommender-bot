...
To help solve the tool discovery problem among software developers, we developed \textit{\tool} to automatically recommend software engineering tools. Our system makes recommendations by integrating characteristics of peer interactions and software engineering practices. \tool~is designed for toolsmiths to increase awareness of their work by automatically running tools and making customized recommendations to developers of GitHub\footnote{https://github.com} projects. This paper seeks to answer the following research questions (RQs): \\
