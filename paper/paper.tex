...
%Learning in SE
Previous research has examined techniques to improve how software engineers learn new information. Cockburn and Williams studied the software engineering practice of \textit{pair programming}, and found that 84\% of participants found the practice to be beneficial for increasing knowledge and helped them learn `` faster and better because [they were] always working with a partner''~\cite{Cockburn2001PairProgramming}.  Gordon and colleagues developed Codepourri, a system that uses \textit{crowdsourcing} to create visual Python tutorials to improve information presented to learners~\cite{Gordon2015Codepourri}. Piorkowski and colleagues applied \textit{information foraging theory} to software engineers to determine how developers debug and propose software engineering tools integrate this process into their workflow~\cite{FlemingReactiveInformationForaging}. This project also seeks to improve software engineer learning, however our approach specifically aims to increase awareness of useful software engineering tools to help developers in their work.

%Other existing approaches
Researchers have also developed approaches to improve recommendations to software engineers. Fischer and colleagues encourage the use of \textit{active help systems} to guide users over passive help systems that require users to explicitly seek help~\cite{Fischer1984ActiveHelpSystems}. Cao and colleagues introduced \textit{idea gardening}, an approach for helping end-user programmers overcome barriers. Linton and colleagues implemented organization-wide learning (OWL) by using system logs make recommendations to employees throughout a company~\cite{Linton2000OWL}. Our work builds on research in this area by introducing a distinctive recommendation approach with three original design principles to make tool suggestions to developers more effective.

%Other existing tools
More specifically, researchers and toolsmiths have developed automated recommender systems to increase awareness of software engineering tools.  Maltzahn and colleagues developed ToolBox, a ``community sensitive help system'' to recommend Unix commands~\cite{Maltzahn1995Toolbox}.  SpyGlass automatically recommends tools to help users navigate code~\cite{Viriyakattiyaporn2010Spyglass}. To improve the effectiveness of automated system-to-user recommendations, we implemented \tool~to evaluate our novel approach based on design principles derived from user-to-user recommendations.

%Other existing evaluations
Existing research has also focused on different recommendation styles for software engineering tools. Murphy-Hill and colleagues outlined existing ways to make recommendations to present and evaluate new algorithms based on collaborative filtering and feature discovery~\cite{Murphy-HillDeveloperFluency}. Winters and colleagues analyzed different styles of tool recommendationsand found that suggestion style impacts tool adoption for software developers~\cite{Mike Winters}. This research introduces a brand new recommendation style and measures the effectiveness of our approach by comparing it to other various styles of recommendations.
