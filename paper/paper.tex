...
\item build with Maven and contain a \textit{pom.xml} file in the top directory,
\item and were ranked among the top 100 forked repositories for a month since February 2008.
\end{itemize}

Using a GitHub search API with the above constraints, we identified 917 projects for our evaluation.\footnote{\url{https://docs.google.com/spreadsheets/d/1MRmVPiUeDlYMa0UODzMmFbGeYBbahzdeEv1YSgqC1oo/edit?usp=sharing}} We selected the most forked repositories to collect popular projects with a lot of activity, and forking a repository is suggested as one of the GitHub contributor best practices and is a requirement by many projects for submitting a pull request to make changes to the master code base. 
...
To gather data on the usefulness of our system, we sent a follow-up survey to developers. Survey participants were users who received a recommendation from \tool~on their pull request. We asked developers four questions about their awareness of \textsc{Error Prone}, their static analysis tool usage, the usefulness of our recommendation, and how likely they are to use \textsc{Error Prone} in the future. The survey also included a free-response section to provide an opportunity for participants to add any other comments or feedback about the recommendation.
...
For our second research question, we accumulated responses from developers in our follow-up survey to determine the usefulness of our system. Dichotomous questions with Yes/No responses were used to gather information on if developers had prior knowledge of the existence of \textsc{Error Prone} and if they normally use static analysis tools during their work. Participants were also asked to list the static analysis tools they work with during software development. We utilized a five-point Likert scale for participants to rank how how helpful they found our recommendation and how likely they are to use \textsc{Error Prone} for future development tasks. These responses were used to analyze developers' reactions to our automated recommendation. Finally, researchers analyzed and independently coded open-ended responses from participants to further analyze the effectiveness of our system based on developer feedback.
