...
/**
 * Add comment to make a tool recommendation on GitHub review
 */
public class Comment {		
     ...
     */
    /*private static void comment(RepoCommit.Smart commit, String comment, String hash, String file, int line) {
        try {
            Comments comments = commit.comments();
            Comment.Smart smartComment = new Comment.Smart(comments.post(comment, hash, file, line));	
